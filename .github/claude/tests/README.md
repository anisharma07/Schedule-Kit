...
This directory contains comprehensive tests generated by Claude AI for the Schedule-Kit project.
The tests are designed to provide good coverage and catch real bugs in your application.

## 🧪 Generated Test Files

- `Card.test.tsx` - Application tests
- `ConicGradient.test.tsx` - Application tests
- `AiCard.test.tsx` - Application tests
- `Loader.test.tsx` - Application tests
- `TagColorPicker.test.tsx` - Application tests
- `Header.test.tsx` - Application tests
- `CardMenu.test.tsx` - Application tests
- `auth-services.test.ts` - Service layer tests
- `functions.test.ts` - Application tests
- `store.test.ts` - Application tests
